...
func (cs *State) scheduleRound0(rs *cstypes.RoundState) {
	cs.Logger.Info("scheduleRound0", "now", cmttime.Now().Format(time.StampMicro), "startTime", cs.StartTime.Format(time.StampMicro))
...
func (cs *State) finalizeCommit(height int64) {
	...
	logger.Info("ApplyVerifiedBlock start", "now", cmttime.Now().Format(time.StampMicro))
